...
TMP_ROOT=$(mktemp -d "${TMPDIR:-/tmp}/claude-playground.XXXXXX")
...
export FAKE_EXPECTED_OUTPUT="$ROOT/fixtures/expected-output.json"
...
echo "PASS: runner supplied the expected non-interactive safety contract"
